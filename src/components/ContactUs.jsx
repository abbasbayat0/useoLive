...
const ContactUs = () => {
  return (
    <div className="w-screen max-w-[1536px] flex flex-col sm:flex-row-reverse relative justify-between items-center mt-10 p-10 900:-mb-28 xl:-mb-40">
      ...
      {/* header */}
      <div className="bg-[#B094CA] rounded-3xl p-10 shadow-md m-10 w-full sm:w-1/3 flex flex-col gap-8 sm:absolute z-10 sm:left-0 375:w-10/12 425:w-8/12 520:w-6/12 810:w-4/12 900:w-3/12 900:left-5 1100:left-14 xl:left-20 xl:w-72 1400:left-28">
      ...
      {/* main */}
      <div className="w-full sm:w-8/12 p-2 sm:mr-0 900:mr-5 1100:mr-14 xl:mr-20 1400:mr-28">
        ...
        >
          <input
            type="text"
            placeholder="نام"
            className="text-center sm:text-end w-1/2 sm:w-3/12 border-b-2 p-2 xl:w-2/12"
          />
          <input
            type="text"
            placeholder="ایمیل"
            className="text-center sm:text-end w-9/12 sm:w-6/12 border-b-2 p-2 xl:w-4/12"
          />
          <input
            type="text"
            placeholder="پیغام"
            className="text-center sm:text-end w-full sm:w-10/12 border-b-2 p-2 xl:w-6/12"
          />
          <input
            type="submit"
            value="ارسال"
            className="w-1/4 h-8 rounded-xl text-white bg-[#b094ca] xl:w-1/5"
          />
        </form>
      </div>

      {/* icons */}
      <div className="bg-[#F4E9FF] w-full rounded-full sm:rounded-lg mt-10 sm:mt-0 sm:w-4/12 sm:h-[450px] flex justify-around sm:items-end p-5 sm:ml-0 375:w-8/12 425:w-7/12 520:w-5/12 810:w-3/12 900:w-2/12 900:ml-5 1100:ml-14 xl:ml-20 xl:w-60 1400:ml-28">
